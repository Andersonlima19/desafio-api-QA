...
A API utilizada no desafio é a ServeRest, uma API pública voltada para testes: 🔗 https://serverest.dev
...
📁 Estrutura do Projeto desafio-api-QA/ ├── cypress/ │ ├── e2e/ │ │ ├── login.cy.js │ │ ├── usuarios.cy.js │ │ ├── produtos.cy.js │ │ └── carrinhos.cy.js │ ├── support/ │ │ ├── api.js │ │ └── commands.js │ └── fixtures/ │ └── produtos.json ├── .github/ │ └── workflows/ │ └── cypress.yml ├── cypress.config.js ├── package.json ├── README.md

🔍 Levantamento de Cenários (Mapeamento Completo) 🔐 Login
...
▶️ Execução dos Testes Localmente Pré-requisitos

Node.js 18+

Git

Passos git clone https://github.com/SEU_USUARIO/desafio-api-QA.git cd desafio-api-QA npm install npx cypress run
